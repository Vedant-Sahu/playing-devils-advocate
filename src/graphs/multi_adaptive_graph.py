"""
Multi-Adaptive Graph - Multi-student iterative explanation improvement.
...
from src.agents.teacher_agent import multi_student_adaptive_teacher_node
from src.agents.student_agent import multi_student_critiques_node, single_answer_node
...
class State(TypedDict, total=False):
    """State shared across all nodes in the multi-adaptive graph."""
...
def create_multi_adaptive_graph() -> StateGraph:
    """
    Create and configure the multi-adaptive graph.
    
    This graph implements a multi-student system where:
    ...
    5. Leakage checker verifies teacher hasn't leaked the answer
    6. Students answer questions based on explanation
    7. Grading agent evaluates final learning outcomes
    ...
    # Add agent nodes
    graph.add_node("teacher", multi_student_adaptive_teacher_node)
...
def create_initial_state(
    ...
    """
    Create initial state for the multi-adaptive graph.
